 ...
 */
interface SysRoleDeptService : IService<SysRoleDeptEntity> {

    fun saveOrUpdate(roleId: Long?, deptIdList: List<Long>)

    /**
     * 根据角色ID，获取部门ID列表
     */
    fun queryDeptIdList(roleIds: Array<Long>): List<Long>
